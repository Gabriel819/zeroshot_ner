...
class BIOMbertWholeDataset(Dataset):
    def __init__(self, lang, split, max_seq_len, ratio=100):
        super(BIOMbertWholeDataset, self).__init__()
        if lang == 'english':
            self.file = json.load(
        ...
        self.tokenizer = BertTokenizer.from_pretrained("/jimin/huggingface/hub/models--google-bert--bert-base-multilingual-cased/snapshots/3f076fdb1ab68d5b2880cb87a0886f315b8146f8", local_files_only=True)
