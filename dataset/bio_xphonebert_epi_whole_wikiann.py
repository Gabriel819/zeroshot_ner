...
class BIOXphoneBERTEpiWikiAnnDataset(Dataset):
    def __init__(self, lang, split, max_seq_len, ratio=100):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("/jimin/huggingface/hub/models--vinai--xphonebert-base/snapshots/10244364dd88eee9e84d7bf1d8898e4b9df5182b", local_files_only=True)
...
if __name__ == '__main__':
    dataset = BIOXphoneBERTEpiWikiAnnDataset('english', 'validation', 128)
