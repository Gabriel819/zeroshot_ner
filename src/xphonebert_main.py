...
def main(args):
    ...
    if args.model == 'bio_xphonebert':
        ##### Model - BIO xPhoneBERT #####
        logging.info('Loading BIO Tagging xPhoneBERT model')
    ...
    if args.do_train:
        ...
        for lang in zero_shot_lang_list:
            ...
            zeroshot_dataset = bio_xphonebert_epi_whole_wikiann.BIOXphoneBERTEpiWikiAnnDataset(lang, 'validation', args.max_seq_len)
