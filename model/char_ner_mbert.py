...
class CharNERBertModel(BertPreTrainedModel):
    """
    ...
    def __init__(self, config, num_classes):
        ...
        self.embeddings = tmp_model.embeddings
        self.encoder = tmp_model.encoder

        self.pooler = tmp_model.pooler
    ...
    def forward(
        ...
        tmp =  BaseModelOutputWithPoolingAndCrossAttentions(
